...
@WebServlet(urlPatterns = {"/loadGiay"})
public class LoadMoreGiay extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        int imount = Integer.parseInt(req.getParameter("exitsGiay"));
        List<Product> list = serviceProduct.Next4ProductG(imount);
        ...
        for (Product product : list) {
            ...
            out.println("<div class=\"productGiay  product-item border-0 mb-4\">");
